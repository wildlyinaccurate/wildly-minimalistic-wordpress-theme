    ...
    function _mbbasetheme_comment($comment, $args, $depth)
    {
        ...
        switch ($comment->comment_type) :
            ...
            case 'trackback' :
                ...
                <p><?php _e('Pingback:', '_mbbasetheme'); ?> <?php comment_author_link(); ?><?php edit_comment_link(
                        __('(Edit)', '_mbbasetheme'),
                        ' '
                    ); ?></p>
                <?php
                break;
                    ...
                    <div id="comment-<?php comment_ID(); ?>" class="comment">
                        <div>
                            <div class="comment-author vcard">
                                ...
                                <?php printf(
                                    __('%s <span class="says">says:</span>', '_mbbasetheme'),
